...
FEATURE_ALIASES = {
    ...
    "Jet1deepCSV": ["Jet1deepCSV", "Jet1PNet", "Jet1deepJet", "lead_bjet_deepCSV", "lead_bjet_PNetB", "lead_bjet_btagDeepFlavB"],
    "dRJet12": ["dRJet12", "DeltaR_j1j2", "DeltaR_jj"],
    "dPhiJet12": ["dPhiJet12", "DeltaPhi_j1j2", "DeltaPhi_jj"],
    "Jet1Pt": ["Jet1Pt", "jet1_pt", "lead_bjet_pt"],
    "Jet2deepCSV": ["Jet2deepCSV", "Jet2PNet", "Jet2deepJet", "sublead_bjet_deepCSV", "sublead_bjet_PNetB", "sublead_bjet_btagDeepFlavB"],
...
RAW_ALIASES = {
    ...
    "jet1_btag": ["Jet1deepCSV", "Jet1PNet", "Jet1deepJet", "lead_bjet_deepCSV", "lead_bjet_PNetB", "lead_bjet_btagDeepFlavB"],
    "jet2_btag": ["Jet2deepCSV", "Jet2PNet", "Jet2deepJet", "sublead_bjet_deepCSV", "sublead_bjet_PNetB", "sublead_bjet_btagDeepFlavB"],
