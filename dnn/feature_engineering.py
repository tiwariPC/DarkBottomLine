...
FEATURE_ALIASES = {
    ...
    "Jet1BTagScore": ["Jet1BTagScore", "Jet1deepCSV", "Jet1PNet", "Jet1UParT", "Jet1deepJet", "lead_bjet_deepCSV", "lead_bjet_PNetB", "lead_bjet_btagDeepFlavB"],
    "dRJet12": ["dRJet12", "DeltaR_j1j2", "DeltaR_jj"],
    "dPhiJet12": ["dPhiJet12", "DeltaPhi_j1j2", "DeltaPhi_jj"],
    "Jet1Pt": ["Jet1Pt", "jet1_pt", "lead_bjet_pt"],
    "Jet2BTagScore": ["Jet2BTagScore", "Jet2deepCSV", "Jet2PNet", "Jet2UParT", "Jet2deepJet", "sublead_bjet_deepCSV", "sublead_bjet_PNetB", "sublead_bjet_btagDeepFlavB"],
    ...
    "METPhi": ["METPhi", "pfMetCorrPhi", "PuppiMET_phi", "PFMET_phi", "MET_phi", "puppiMET_phi", "met_phi"],
    "Jet1Phi": ["Jet1Phi", "jet1_phi", "lead_bjet_phi"],
    "MET": ["MET", "MET_pt", "pfMetCorrPt", "PuppiMET_pt", "PFMET_pt", "puppiMET_pt", "met_pt"],
...
RAW_ALIASES = {
    ...
    "met_pt": ["MET", "MET_pt", "pfMetCorrPt", "PuppiMET_pt", "PFMET_pt", "puppiMET_pt", "met_pt"],
    "met_phi": ["METPhi", "MET_phi", "pfMetCorrPhi", "PuppiMET_phi", "PFMET_phi", "puppiMET_phi", "met_phi"],
    "jet1_btag": ["Jet1BTagScore", "Jet1deepCSV", "Jet1PNet", "Jet1UParT", "Jet1deepJet", "lead_bjet_deepCSV", "lead_bjet_PNetB", "lead_bjet_btagDeepFlavB"],
    "jet2_btag": ["Jet2BTagScore", "Jet2deepCSV", "Jet2PNet", "Jet2UParT", "Jet2deepJet", "sublead_bjet_deepCSV", "sublead_bjet_PNetB", "sublead_bjet_btagDeepFlavB"],
