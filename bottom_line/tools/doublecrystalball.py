# DCB function borrowed from coffea: https://github.com/scikit-hep/coffea/blob/master/src/coffea/lookup_tools/doublecrystalball.py
# with "betaH > 0" discussed here: https://gitlab.cern.ch/cms-analysis/general/HiggsDNA/-/merge_requests/352#note_8933868
