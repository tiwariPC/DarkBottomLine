...
echo "=========================================="
echo "DarkBottomLine Condor Job (btag-efficiency)"
echo "=========================================="
echo "Job ID: ${1:-0}"
...
if [ -n "${BKG_FILE}" ]; then
    ...
    OUTPUT="outputs/btageff/${YEAR}/${BKG_NAME}_${FILE_INDEX}.root"
else
...
# Build command: single-file NanoAOD -> b-tag efficiency-map ROOT
CMD="python3 scripts/btag_efficiency_slimmer.py"
...
echo "=========================================="
echo "Running B-tag Efficiency Slimmer"
echo "=========================================="
echo "Command: ${CMD}"
echo ""
...
if eval "${CMD}"; then
    ...
    echo ""
    echo "=========================================="
    echo "B-tag Efficiency Slimmer Completed Successfully!"
    echo "=========================================="
    echo "Output: ${OUTPUT}"
    ...
    echo ""
    echo "=========================================="
    echo "B-tag Efficiency Slimmer Failed!"
    echo "=========================================="
